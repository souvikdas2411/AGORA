 ...
 */
public final class StringNonEqual extends TwoString {
  ...
  public static final Logger debug = Logger.getLogger("daikon.inv.binary.twoScalar.StringNonEqual");

  StringNonEqual(PptSlice ppt) {
    super(ppt);
  }

  @Prototype StringNonEqual() {
    super();
  }

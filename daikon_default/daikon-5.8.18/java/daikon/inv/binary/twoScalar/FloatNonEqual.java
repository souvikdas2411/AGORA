 ...
 */
public final class FloatNonEqual extends TwoFloat {
  ...
  public static final Logger debug = Logger.getLogger("daikon.inv.binary.twoScalar.FloatNonEqual");

  FloatNonEqual(PptSlice ppt) {
    super(ppt);
  }

  @Prototype FloatNonEqual() {
    super();
  }

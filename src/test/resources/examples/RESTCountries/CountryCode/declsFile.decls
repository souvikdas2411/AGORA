...
ppt /alpha/{code}&v3Code&200%array():::ENTER
ppt-type enter
variable input
	var-kind variable
	dec-type v3Code&Input
	rep-type hashcode
...
ppt /alpha/{code}&v3Code&200():::ENTER
ppt-type enter
variable input
	var-kind variable
	dec-type v3Code&Input
...
ppt /alpha/{code}&v3Code&200%array():::EXIT1
ppt-type subexit
variable input
	var-kind variable
	dec-type v3Code&Input
...
variable return
	var-kind return
	dec-type v3Code&Output&200%array
	rep-type hashcode
...
ppt /alpha/{code}&v3Code&200():::EXIT2
ppt-type subexit
variable input
	var-kind variable
	dec-type v3Code&Input
...
variable return
	var-kind return
	dec-type v3Code&Output&200
	rep-type hashcode
variable return.name
	var-kind field name
	enclosing-var return
	dec-type v3Code&Output&200&name
	rep-type hashcode
...
variable return.name.nativeName
	...
	enclosing-var return.name
	dec-type v3Code&Output&200&nativeName
	rep-type hashcode
variable return.tld
	var-kind field tld
	enclosing-var return
...
variable return.currencies
	...
	enclosing-var return
	dec-type v3Code&Output&200&currencies
	rep-type hashcode
variable return.idd
	var-kind field idd
	enclosing-var return
	dec-type v3Code&Output&200&idd
	rep-type hashcode
...
variable return.languages
	...
	enclosing-var return
	dec-type v3Code&Output&200&languages
	rep-type hashcode
variable return.translations
	var-kind field translations
	enclosing-var return
	dec-type v3Code&Output&200&translations
	rep-type hashcode
...
variable return.demonyms
	...
	enclosing-var return
	dec-type v3Code&Output&200&demonyms
	rep-type hashcode
...
variable return.maps
	var-kind field maps
	enclosing-var return
	dec-type v3Code&Output&200&maps
	rep-type hashcode
...
variable return.gini
	var-kind field gini
	enclosing-var return
	dec-type v3Code&Output&200&gini
	rep-type hashcode
...
variable return.car
	var-kind field car
	enclosing-var return
	dec-type v3Code&Output&200&car
	rep-type hashcode
...
variable return.flags
	...
	enclosing-var return
	dec-type v3Code&Output&200&flags
	rep-type hashcode
...
variable return.coatOfArms
	...
	enclosing-var return
	dec-type v3Code&Output&200&coatOfArms
	rep-type hashcode
...
variable return.capitalInfo
	...
	enclosing-var return
	dec-type v3Code&Output&200&capitalInfo
	rep-type hashcode
...
variable return.postalCode
	...
	enclosing-var return
	dec-type v3Code&Output&200&postalCode
	rep-type hashcode

...
def create_owner(owner_info):
    ...
    response = requests.post(url, headers=headers, json=owner_info)
...
def main():
    ...
    with open('C:/Users/bhagy/Documents/CS569SEAnalysis/finalProject/script/petclinic_owner_info.csv', 'w', newline='', encoding='utf-8') as csvfile:
        ...
        for i in range(50):  # Creating and fetching data for 50 owners
            owner_id = create_owner(owner_data_template)
            if owner_id:
